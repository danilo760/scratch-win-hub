...
begin
  ...
  -- Serialize only identical logical requests for the same user. This closes
  -- the race where two simultaneous retries both pass the initial lookup and
  -- one later fails on the unique (user_id, client_request_id) index.
